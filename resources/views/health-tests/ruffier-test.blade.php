<x-main-layout>
    ...
    <ol class="list-decimal">
        <li class="ml-16"><b>Resting Heart Rate Measurement: </b>First, you take a rest sitting or lying calmly
            for at least 5 minutes. Then, you check heart rate for 15 seconds.</li>
        ...
        <li class="ml-16"><b>Post-Exercise Heart Rate Measurements: </b>After completing the squats, you immediately take your
             heart rate for 15 seconds, and then in 30 seconds again for 15 seconds.</li>
        <li class="ml-16"><b>Assessment: </b>The Ruffier index is calculated using the following formula:</li>
        <p class="ml-20"><strong>Ruffier Index</strong> = (4 * (P1 + P2 + P3) - 200)) / 10, where: </p>
            <ul>
                <li class="ml-24"><b>P1</b> = the heart rate before the exercise (15 seconds)</li>
                <li class="ml-24"><b>P2</b> = the heart rate immediately after exercise (15 seconds)</li>
                <li class="ml-24"><b>P3</b> = the heart rate in 30 seconds after P2 (15 seconds)</li>
            </ul>
    </ol>
    ...
    <form action="#" method="POST">
        ...
        <section class="grid grid-cols-3 border-1 border-[#4682A1] my-6 mx-64 p-2 rounded-xl">
            <label for="pulse_1" class="col-span-2">Enter heart rate (15 seconds) after rest: </label>
        ...
        <!-- Heart rate 2 -->
        <section class="grid grid-cols-3 border-1 border-[#4682A1] my-6 mx-64 p-2 rounded-xl">
            <label for="pulse_2" class="col-span-2">Enter heart rate (15 seconds) immediately after 30 squats: </label>
        ...
        <!-- Heart rate 3 -->
        <section class="grid grid-cols-3 border-1 border-[#4682A1] my-6 mx-64 p-2 rounded-xl">
            <label for="pulse_3" class="col-span-2">Enter heart rate (15 seconds) in 30 seconds after 2nd heart rate: </label>
